...
namespace update
{
    public class MyWebClient : WebClient
    {
        ...
        protected override WebRequest GetWebRequest(Uri address)
        {
            ...
            request.ContinueTimeout = (int)(this.Timeout * 1000.0f);
            return request;
        }
        public MyWebClient()
        {
        ...
        public string DownloadString(string url)
        {
            ...
            return System.Text.Encoding.UTF8.GetString(got,0,got.Length);
        }
    ...
    {
        Action<string, Exception> downStr;
        public updatemgr()
        {
            wc = new MyWebClient();
        ...
        public void DownLoad(string localpath, string firsturl)
        {
            System.Threading.WaitCallback call = (s) =>
            {
                ...
                try
                {//如果本地下载
                    string str = ReadAllText(System.IO.Path.Combine(localpath, "finishver.txt"));
                ...
                if (errors.Count == 0)
                {
                    ...
                    byte[] b = System.Text.Encoding.UTF8.GetBytes(verinfo.ToString());
